...
class empWage:
    ...
    def monthVice_Salary(self):
        ...
        while (totalWrkDay <= self.__maxempWrkDays and totalWrkHr <= self.__maxempWrkHr):
            ...
            salary_record_list.append(salary) # Python list
            totalSalary += salary

        salary_record_tuple = tuple(salary_record_list) # Python tuples
        return totalSalary,salary_record_tuple
